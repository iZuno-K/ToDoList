...
import BurnDownChartShow from '../pages/Board/BurnDownChart/Show.vue';
import BoardInfoShow from '../pages/Board/BoardInfo/Show.vue';
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            path: 'BurnDownChart',
                            component: BurnDownChartShow,
                            props: route => ({
                                boardId: parseInt(route.params.boardId, 10),
                            }),
                            // meta: {
                            //     ws: route => route.path.split('/BurnDownChart')[0],
                            // },
                        },
                        {
                            path: 'boardInfo',
                            component: BoardInfoShow,
                            props: route => ({
                                boardId: parseInt(route.params.boardId, 10),
                            }),
                            // meta: {
